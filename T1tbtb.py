...
chi1c = Scalar(vtx1,out1c,linestyle=dashed3).addLabel(chi1p,pos=0.5,displace=-.35,size=labelsize,valign=MIDDLE).setStyles(mystyle)
part1d = Vector(out1c,out1d, frequency=0.45, amplitude=0.06).addLabel(Wstarp,displace=0.0,pos=1.25,size=labelsize,valign=MIDDLE,halign=LEFT).setStyles(mystyle)
...
chi2c = Scalar(vtx2,out2c,linestyle=dashed3).addLabel(chi1m,pos=0.5,displace=0.125,size=labelsize,valign=MIDDLE).setStyles(mystyle)
part2d = Vector(out2c,out2d, frequency=0.45, amplitude=0.06).addLabel(Wstarm,displace=0.0,pos=1.30,size=labelsize,valign=MIDDLE,halign=LEFT).setStyles(mystyle)
