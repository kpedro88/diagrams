...
chi1c = Gaugino(vtx1,out1c, frequency=0.60, amplitude=0.09).addLabel(chi20+','+chi1pm,pos=0.5,displace=-.40,size=labelsize,valign=MIDDLE).setStyles(mystyle)
part1d = Vector(out1c,out1d, frequency=0.60, amplitude=0.09).addLabel(Z0+','+Wpm,displace=0.0,pos=1.25,size=labelsize,valign=MIDDLE,halign=LEFT).invert().setStyles(mystyle)
...
chi2c = Gaugino(vtx2,out2c, frequency=0.60, amplitude=0.09).addLabel(chi20+','+chi1pm,pos=0.5,displace=0.15,size=labelsize,valign=MIDDLE).invert().setStyles(mystyle)
part2d = Vector(out2c,out2d, frequency=0.60, amplitude=0.09).addLabel(Z0+','+Wpm,displace=0.0,pos=1.30,size=labelsize,valign=MIDDLE,halign=LEFT).setStyles(mystyle)
