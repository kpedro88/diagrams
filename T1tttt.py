...
chi1c = Gaugino(vtx1,out1c, frequency=0.60, amplitude=0.09).addLabel(chi10,displace=0,pos=1.15,size=labelsize,valign=MIDDLE,halign=LEFT).setStyles(mystyle)
...
chi2c = Gaugino(vtx2,out2c, frequency=0.60, amplitude=0.09).addLabel(chi10,displace=0,pos=1.15,size=labelsize,valign=MIDDLE,halign=LEFT).invert().setStyles(mystyle)
