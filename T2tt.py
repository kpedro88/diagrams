...
st1 = Scalar(vtx0, vtx1, linestyle=dashed3).addLabel(stbar,pos=0.6,displace=+.35,size=labelsize).setStyles(mystyle)
...
top1a = Fermion(vtx1,out1a).addLabel(tbar,displace=0,pos=1.10,size=labelsize,valign=MIDDLE,halign=LEFT).setStyles(mystyle)
